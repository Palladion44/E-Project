...
<html lang="en">
  ...
  <section>
  <div id="carouselExampleControls" class="carousel fade-right" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="ps.jpg" class="d-block w-100" alt="..." style="max-height: 540px;">
      </div>
      <div class="carousel-item">
        <img src="./proimages/carasole5.jpg" class="d-block w-100" alt="..." style="max-height: 540px;">
      </div>
      <div class="carousel-item">
        <img src="./proimages/carosel1.jpg" class="d-block w-100" alt="..." style="max-height: 540px;">
      </div>
    </div>
       ...
       <div class="row py-5">
         ...
         <div class="col-md-4">
           ...
           <div class="card"  style="max-height: 500px;">
             ...
             <div class="card-body">
               <h5 class="card-title" style="font-size: 28px; font-family: 'Times New Roman', Times, serif; color: aqua;">HAPATHSIS B(Hepb)</h5>
         ...
         <div class="col-md-4">
           ...
           <div class="card"  style="max-height: 500px;">
             ...
             <div class="card-body">
               <h5 class="card-title" style="font-size: 28px; font-family: 'Times New Roman', Times, serif; color: aqua;">Rotavirus (RV)</h5>
         ...
         <div class="col-md-4" >
           ...
           <div class="card" >
             ...
             <div class="card-body">
               <h5 class="card-title" style="font-size: 28px; font-family: 'Times New Roman', Times, serif; color: aqua;">Diphtheria Vaccine</h5>
         ...
         <div class="col-md-4 py-5"  >
           ...
           <div class="card" style="max-height: 500px;">
             ...
             <div class="card-body">
               <h5 class="card-title" style="font-size: 28px; font-family: 'Times New Roman', Times, serif; color: aqua;">Pneumcoccal Vaccine</h5>
         ...
         <div class="col-md-4 py-5"  >
           ...
           <div class="card" style="max-height: 500px;">
             ...
             <div class="card-body">
               <h5 class="card-title" style="font-size: 28px; font-family: 'Times New Roman', Times, serif; color: aqua;">Influnza Vaccine</h5>
         ...
         <div class="col-md-4 py-5"  >
           ...
           <div class="card" style="max-height: 500px;">
             ...
             <div class="card-body">
               <h5 class="card-title" style="font-size: 28px; font-family: 'Times New Roman', Times, serif; color: aqua;">Polio Vaccine</h5>
         ...
         <div class="col-md-4 py-5"  >
           ...
           <div class="card" style="max-height: 500px;">
             ...
             <div class="card-body">
               <h5 class="card-title" style="font-size: 28px; font-family: 'Times New Roman', Times, serif; color: aqua;">Measles Vaccine</h5>
         ...
         <div class="col-md-4 py-5"  >
           ...
           <div class="card" style="max-height: 500px;">
             ...
             <div class="card-body">
               <h5 class="card-title" style="font-size: 28px; font-family: 'Times New Roman', Times, serif; color: aqua;">Varicella Vaccine</h5>
         ...
         <div class="col-md-4 py-5"  >
           ...
           <div class="card" style="max-height: 500px;">
             ...
             <div class="card-body">
               <h5 class="card-title " style="font-size: 28px; font-family: 'Times New Roman', Times, serif; color: aqua;">Hepatitis A Vaccine</h5>
